...
export class RideService {
    ...
    public searchRide(startFilter: RideFilterRequest, endFilter: RideFilterRequest): Observable<any> {
        console.log('start Filter is '+JSON.stringify(startFilter))
        console.log('end Filter is '+JSON.stringify(endFilter))

        return this.http.post('/api/rides/filter', {"startFilter": startFilter,"endFilter": endFilter}, {
